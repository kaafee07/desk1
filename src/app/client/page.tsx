                      ...
                      <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
                        <div className="flex justify-between items-center bg-white/60 backdrop-blur-sm border border-gray-200/50 rounded-xl p-3 sm:p-4">
                          <div className="flex items-center">
                            ...
                            <div className="flex items-center">
                              <span className="text-gray-700 font-medium">ساعة</span>
                          ...
                          <div className="text-right">
                            {office.previousPricePerHour && Number(office.previousPricePerHour) > Number(office.pricePerHour) ? (
                              <div className="flex flex-col items-end">
                                <span className="text-gray-400 text-sm line-through">{Number(office.previousPricePerHour)} ريال</span>
                                <span className="font-bold text-red-600 text-lg">{Number(office.pricePerHour)} ريال</span>
                                <span className="text-xs text-green-600 font-medium">وفر {Math.round(Number(office.previousPricePerHour) - Number(office.pricePerHour))} ريال</span>
                              </div>
                            ) : (
                              <span className="font-bold text-gray-900 text-lg">{Number(office.pricePerHour)} ريال</span>
                            )}
                          </div>
                        </div>
                        ...
                        <div className="flex justify-between items-center bg-white/60 backdrop-blur-sm border border-gray-200/50 rounded-xl p-3 sm:p-4">
                          <div className="flex items-center">
                            ...
                            <div className="flex items-center">
                              <span className="text-gray-700 font-medium">يوم</span>
                          ...
                          if (maxDiscount > 0) {
                            return (
                              <div className="text-center mt-4 space-y-2">
                                <div className="inline-flex items-center bg-gradient-to-r from-red-500 to-pink-500 text-white px-4 py-2 rounded-full text-sm font-semibold shadow-lg animate-pulse">
                            ...
                            return (
                              <div className="text-center mt-4">
                                ...
                                <div className="text-xs text-gray-500 mt-2">
                                  أسعار تنافسية بدون خصومات إضافية
                                </div>
                              </div>
                            )
                          }
